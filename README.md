...
[![Flysystem API version](https://img.shields.io/badge/Flysystem%20API-V1-blue?style=flat-square)](https://github.com/thephpleague/flysystem/tree/1.x)
...
[![Build Status](https://img.shields.io/travis/com/masbug/flysystem-google-drive-ext/1.x.svg?style=flat-square)](https://travis-ci.com/masbug/flysystem-google-drive-ext)
...
```php
$drives = $fs->getAdapter()->getService()->listTeamdrives()->getTeamDrives();
